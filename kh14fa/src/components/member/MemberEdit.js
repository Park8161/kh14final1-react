...
const MemberEdit = ()=>{
    ...
    const checkMemberAddress = useCallback(()=>{
        const check1 = edit.memberPost.length === 0 && edit.memberAddress1.length === 0 && edit.memberAddress2.length === 0;
        const check2 = edit.memberPost.length > 0 && edit.memberAddress1.length > 0 && edit.memberAddress2.length > 0;
