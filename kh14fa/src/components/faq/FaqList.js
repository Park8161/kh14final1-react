...
온라인 개인 계정 : 개인 계정 및 인증번호를 통해 각종 피해가 발생되고 있어 Once Upon a Time 운영정책에 따라 제재 됩니다.
...
사행성 : 불법 도박 및 사행성 상품은 Once Upon a Time 운영정책에 따라 제재 됩니다.
...
Once Upon a Time에서는 구매확정을 하는 즉시, 상품 판매 대금이 판매자에게 정산돼요.
...
따라서 Once Upon a Time에서는 배송 전 구매확정을 요청하는 것을 운영 정책 상 금지하고 있어요.

이런 행위를 하는 판매자를 만났다면 아래 신고 경로를 통해 신고를 접수해 주세요.

► 상품 페이지 → 신고하기 
► 상점 상세 → 신고하기 
► 개인톡 대화방 → 우측 상단 설정 → 신고하기 
► 개인톡 대화방 → 주의 안내 시스템 메시지 하단 [Once Upon a Time에 알려주기] → 1:1 문의하기 → 안전결제/거래신고

사기 피해 방지를 위해서 반드시 상품을 수령한 후 상품 상태를 확인한 후에 구매확정을 해주세요.  

 

Once Upon a Time에서는 안전한 거래 환경 정착을 위해 끊임없이 노력하고 있습니다. 

앞으로 안전결제를 통해 보다 만족스러운 거래 경험을 제공해 드릴 것을 약속드릴게요. 

판매자는 신뢰받고 구매자가 안심할 수 있는 안전한 중고거래 문화를 만들어가는 Once Upon a Time가 되겠습니다.`
    ]
...
“개인정보 보호법 제20조의2(개인정보 이용 제공 내역의 통지)”에 따라 Once Upon a Time에서 개인정보가 
...
2. 저는 탈퇴 했는데, 왜 개인정보 이용내역 메시지가 왜 발송 된거죠? 
 ...
 12/1일을 기준으로 Once Upon a Time의 가입자를 대상으로 발송하였습니다.

 12/1일 이후 탈퇴를 하신 경우 메시지를 받으실 수 있습니다.. 



3. Once Upon a Time을 이용한 적이 없는데 메시지를 받았어요. 

  가입 시 등록하신 휴대폰번호를 기준으로 개인정보 이용내역을 통지하고 있습니다.

  휴대폰번호 변경 후 메시지를 수신한 경우 고객센터(0000-0000)으로 문의 부탁드립니다. 
...
판매자로 인해 불편을 겪게 한 것에 대해 Once Upon a Time이 대신 먼저 사과 드릴게요.
