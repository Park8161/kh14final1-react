            ...
            <div className="col-8 offset-2">
                ...
                <div className="row mt-4">
                    <div className="col">
                        ...
                        <div className="input-group">
                            ...
                            <input type="text" className="form-control" value={input.categoryName} onChange={e => setInput({...input, categoryName: e.target.value })} />
                        </div>
                    </div>
                </div>
                ...
                <div className="row mt-4">
                    <div className="col text-end">
                        ...
                        <button className="btn btn-success" onClick={e=>updateCategory(input)}>
                            등록하기
                        </button>
                    </div>
                </div>
